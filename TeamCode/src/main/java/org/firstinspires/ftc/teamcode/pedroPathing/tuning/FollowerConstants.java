...
public class FollowerConstants {
    ...
    //robot width 16.5 (left wheel to right wheel)
    //robot length 17 (front of claw to back of bot)
    ...
    private static double xMovement = 62.16674288645345;
    private static double yMovement = 39.1057146302161;
    ...
    // TODO: fix mass
    public static double mass = 8.708974;
    ...
    public static double forwardZeroPowerAcceleration = -43.80364618359951; //172.28667634300888

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -52.756545244148406; //160.0573119220662
