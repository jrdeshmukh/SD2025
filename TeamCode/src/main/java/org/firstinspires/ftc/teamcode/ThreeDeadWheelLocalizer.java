...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1922.8725888636602; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2210.52075207713; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1007.1229343144053; // x position of the perpendicular encoder (in tick units)
    }
